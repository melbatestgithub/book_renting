...
const Sidebar = () => {
  ...
  const menuItems = [
    { text: 'Dashboard', icon: <DashboardIcon sx={{ color: activeItem === 'Dashboard' ? 'white' : '#B6B6B6' }} />, link: '/owner-dashboard' },
    { text: 'Book Upload', icon: <BookIcon sx={{ color: activeItem === 'Books' ? 'white' : '#B6B6B6' }} />, link: '/book-upload' },
    ...
    { text: 'Login as Admin', icon: <ExitToAppIcon sx={{ color: activeItem === 'Login as Book owner' ? 'white' : '#B6B6B6' }} />, link: '/login' },
  ];

...
const navigate=useNavigate()
  ...
  const menuItems = [
    { text: 'Dashboard', icon: <DashboardOutlinedIcon sx={{ color: activeItem === 'Dashboard' ? 'white' : '#B6B6B6' }} />, link: '/' },
    { text: 'Books', icon: <LibraryBooksIcon sx={{ color: activeItem === 'Books' ? 'white' : '#B6B6B6' }} />, link: '/books' },
    { text: 'Owners', icon: <PermIdentityIcon sx={{ color: activeItem === 'Owners' ? 'white' : '#B6B6B6' }} />, link: '/owners' },
  ...
  const menuItems2=[
    ...
    { text: 'Login as Book owner', icon: <AccountCircleIcon sx={{ color: activeItem === 'Login as Book owner' ? 'white' : '#B6B6B6' }} />, link: '/login' },
  ]
